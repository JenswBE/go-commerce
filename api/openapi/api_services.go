...
func (r ApiListServiceCategoriesRequest) Execute() (*ResolvedServiceCategoryList, *http.Response, error) {
	return r.ApiService.ListServiceCategoriesExecute(r)
}
...
func (a *ServicesAPIService) ListServiceCategoriesExecute(r ApiListServiceCategoriesRequest) (*ResolvedServiceCategoryList, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *ResolvedServiceCategoryList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicesAPIService.ListServiceCategories")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/service_categories/"
