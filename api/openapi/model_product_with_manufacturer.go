...
func NewProductWithManufacturer(name string, price int64) *ProductWithManufacturer {
...
func (o *ProductWithManufacturer) GetStatus() ProductStatus {
...
// and a boolean to check if the value has been set.
func (o *ProductWithManufacturer) GetStatusOk() (*ProductStatus, bool) {
	if o == nil || o.Status == nil {
		return nil, false
	}
...
func (o *ProductWithManufacturer) SetStatus(v ProductStatus) {
	o.Status = &v
}
...
func (o *ProductWithManufacturer) GetImageUrls() []map[string]string {
...
// and a boolean to check if the value has been set.
func (o *ProductWithManufacturer) GetImageUrlsOk() (*[]map[string]string, bool) {
	if o == nil || o.ImageUrls == nil {
		return nil, false
	}
...
func (o *ProductWithManufacturer) SetImageUrls(v []map[string]string) {
	o.ImageUrls = &v
}
