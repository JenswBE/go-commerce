...
func (r ApiAddEventRequest) Event(event Event) ApiAddEventRequest {
	r.event = &event
	return r
}

func (r ApiAddEventRequest) Execute() (*Event, *http.Response, error) {
	return r.ApiService.AddEventExecute(r)
}

/*
AddEvent Method for AddEvent
...
*/
func (a *EventsApiService) AddEvent(ctx context.Context) ApiAddEventRequest {
	return ApiAddEventRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Event
func (a *EventsApiService) AddEventExecute(r ApiAddEventRequest) (*Event, *http.Response, error) {
	var (
...
func (a *EventsApiService) ListEventsExecute(r ApiListEventsRequest) (*EventList, *http.Response, error) {
	...
	if r.includePastEvents != nil {
		localVarQueryParams.Add("include_past_events", parameterToString(*r.includePastEvents, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
