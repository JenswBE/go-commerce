...
type ApiListContentRequest struct {
	ctx context.Context
	ApiService *ContentApiService
}

func (r ApiListContentRequest) Execute() (*ContentList, *http.Response, error) {
	return r.ApiService.ListContentExecute(r)
}

/*
ListContent Method for ListContent

List content

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListContentRequest
*/
func (a *ContentApiService) ListContent(ctx context.Context) ApiListContentRequest {
	return ApiListContentRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ContentList
func (a *ContentApiService) ListContentExecute(r ApiListContentRequest) (*ContentList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContentApiService.ListContent")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateContentRequest) Execute() (*Content, *http.Response, error) {
...
*/
func (a *ContentApiService) UpdateContent(ctx context.Context, contentName string) ApiUpdateContentRequest {
	return ApiUpdateContentRequest{
		ApiService: a,
		ctx: ctx,
		contentName: contentName,
...
// Execute executes the request
//  @return Content
func (a *ContentApiService) UpdateContentExecute(r ApiUpdateContentRequest) (*Content, *http.Response, error) {
	var (
