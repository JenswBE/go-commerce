...
type _ResolvedProduct ResolvedProduct
...
func (o *ResolvedProduct) UnmarshalJSON(bytes []byte) (err error) {
	...
	varResolvedProduct := _ResolvedProduct{}

	err = json.Unmarshal(bytes, &varResolvedProduct)

	if err != nil {
		return err
	}

	*o = ResolvedProduct(varResolvedProduct)
